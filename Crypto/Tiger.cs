...
namespace Crypto
{
	...
	{
		public static readonly ulong[] t1 = {
		...
		public static readonly ulong[] t2 = {
		...
		public static readonly ulong[] t3 = {
		...
		public static readonly ulong[] t4 = {
	...
	public partial class Tiger : BlockHashAlgorithm
	{
		...
		protected override byte[] ProcessFinalBlock(byte[] inputBuffer, int inputOffset, int inputCount)
		{
			...
			if (inputCount + 8 >= BlockSize)
			{
				...
				inputOffset += BlockSize; _ = BlockSize;
			}
